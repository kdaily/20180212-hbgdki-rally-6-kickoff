---
title: "HBGDKi - Rally 7 and Synapse"
...
- gets you on the [HBGDki Rally 7 Team](https://www.synapse.org/#!Team:3368754)
...
Go to https://www.synapse.org/hbgdki_sprint_7A (syn11855121)
...
install.packages("synapser", 
                 repos=c("https://sage-bionetworks.github.io/ran",
                         "http://cran.fhcrc.org"))
```
...
<img src="img/project-sprint7A.png" width="100%"/>
<br>
...
<img src="img/files-sprint7A.png" width="100%"/>
<br/>
...
We'll use this for sprint check-ins - make sure you follow forum and threads!

https://www.synapse.org/#!Synapse:syn11855121/discussion/

<img src="./img/discussion-sprint7A.png" width="90%" />
...
- [Rally Discussion Forum](https://www.synapse.org/#!Synapse:syn11855121/discussion/)

## Presentation

# This presentation is available at [syn11915239](https://www.synapse.org/#!Synapse:syn11915239).
...
rmd <- getPermlink(repo, "presentation-hbgdki-rally7.Rmd")

# Render as HTML
x <- rmarkdown::render("./presentation-hbgdki-rally7.Rmd")

# Store in Synapse with provenance to Github file
f <- synStore(File(x, parentId="syn11915215"), used=rmd)
```
